...
class gui(interface):
	def __init__(self):
		...
		self.exp_dir = '/home/vinicius/tof/basler/record/test/'
		self.x_reader = reader(self.exp_dir+'x.out')
		self.y_reader = reader(self.exp_dir+'y.out')
		self.z_reader = reader(self.exp_dir+'z.out')
